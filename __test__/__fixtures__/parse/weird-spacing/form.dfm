object
  ...
  Left =
         ...
         192
  Font.Name = 'MS Sans Serif' Font.Style = []   Border.Bottom.Style = bdSolid   object Image1: TImage
    Picture.Data = {
  ...
  inherited ListBox1: TListBox [2]
                         ...
                         Items.Strings =
      ( 'this is string.' 'and another one...'      + 'and another one...'+ 'now with apostrophe '''#13#10'how fancy'
      )
    Items.MoreStrings = ()
  end
  ...
  object MyContainer: TContainer Cost = 32.5c MinCost = 0c Multiplier = 12.5s Date = 47000.1d end
  object Edit2: TEdit
